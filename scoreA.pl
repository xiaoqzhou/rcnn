...
my %labelMappingCoarse = ('Good'=>'Good', 'Bad'=>'Bad', 'Potential'=>'Pot.', 'Dialogue'=>'Bad', 'Not English'=>'Bad', 'Other'=>'Bad');

my %confMatrixFine     = ();
my @allLabelsFine      = ('Good', 'Bad', 'Pot.', 'Dial');
my %labelMappingFine   = ('Good'=>'Good', 'Bad'=>'Bad', 'Potential'=>'Pot.', 'Dialogue'=>'Dial', 'Not English'=>'Bad', 'Other'=>'Bad');
...
while (<GOLD>) {
	...
	# Q2601_C1	Dialogue
	die "Wrong file format!" if (!/^Q([0-9]+_C[0-9]+)\t(Good|Bad|Potential|Dialogue|Not English|Other)$/);
